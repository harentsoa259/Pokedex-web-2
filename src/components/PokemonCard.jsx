...
function PokemonCard({ pokemon }) {
  ...
  return (
      <Tilt glareEnable={true} glareColor="#ffffff" glareMaxOpacity={0.2} scale={1.1}>
      <div className={`rounded-lg shadow-md p-4 text-white transition hover:scale-105 animate-fade-in hover:shadow-xl hover:shadow-white/20`}
